public class Guardian {
    ...
    public String play(Child child) {
        String color = child.getFavColor();
        String sport = child.getSport();
        int age = child.getAge();

        if (color.equals("blue") || color.equals("orange") || color.equals("black")) {
            return "played pretend";
        } else if (sport.contains("ball")) {
