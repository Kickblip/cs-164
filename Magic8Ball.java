...
public class Magic8Ball {
    ...
    public String positiveAnswer(int magicNum){
        ...
        if ((magicNum >= 13) && (magicNum <= 27)) {
            return "Signs point to yes.";
        }
        if ((magicNum > 27) && (magicNum < 78)) {
            return "Outlook good.";
        }
        if (magicNum >= 78){
    ...
    public String negativeAnswer(int magicNum){
        ...
        if ((magicNum >= 6) && (magicNum <= 43)) {
            return "My reply is no.";
        }
        if ((magicNum > 43) && (magicNum < 89)) {
    ...
    public String neutralAnswer(int magicNum){
        ...
        if ((magicNum >= 23) && (magicNum <= 35)) {
            return "Ask again later.";
        }
        if ((magicNum > 35) && (magicNum < 62)) {
