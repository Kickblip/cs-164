    ...
    */
    public ProperFraction(int wholeNumber, int numerator, int denominator){
        if (denominator == 0){
            ...
            this.wholeNumber = wholeNumber + (numerator / denominator);
    ...
    public ProperFraction(String fraction){
        int wholeNumber = Integer.parseInt(fraction.substring(0, fraction.indexOf(" ")));
        int numerator = Integer.parseInt(fraction.substring(fraction.indexOf(" ") + 1, fraction.indexOf("/")));
    ...
    public ImproperFraction makeImproper(){
        ...
        return new ImproperFraction(newNumerator, newDenominator);
