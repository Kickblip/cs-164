public class Salad implements MenuItem {
    ...
    public Salad(String orderLine){
        String infoString = orderLine.substring(orderLine.indexOf(',')+1);
        this.size = infoString.substring(0, infoString.indexOf(','));
        this.dressing = infoString.substring(infoString.indexOf(',')+1);
    }
